...
char* read_json_file(const char* path){
    ...
    char* buffer;           //con trỏ tới chuỗi sẽ đọc ra từ file
    unsigned long length;   //độ dài của file
    ...
    buffer[length] = '\0'; //xác định vị trí kết thúc chuỗi
