/* 
    YÊU CẦU : Áp dụng các hàm malloc,realloc để quản lý bộ nhớ lưu trữ chuỗi sau phần tách
    MỤC TIÊU: Thay thế việc cấp phát mảng tĩnh sang mảng động để tối ưu bộ nhớ 
*/
#include <stdio.h>
#include <string.h> //
#include <stdlib.h> // 
...
int main()
{
    const char *buffer = "    \"temperatures\":23"
                         "    \"humidity\":45"
                         "  \"Speed\":12"
                         "\"Light\": 89"
                         "\"Humi\": 97"
