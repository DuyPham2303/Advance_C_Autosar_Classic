...
static const PduR_RxRoutingEntryType PduR_RxRoutingTable[PDUR_RX_TABLE_SIZE] = {
    ...
    /*  
        {PduR_PROTOCOL_CAN, 1, PduR_DEST_DCM, 1},
        {PduR_PROTOCOL_CAN, 2, PduR_DEST_FIM, 2},

        {PduR_PROTOCOL_LIN, 0, PduR_DEST_COM, 0},
        {PduR_PROTOCOL_LIN, 1, PduR_DEST_DCM, 1},
        {PduR_PROTOCOL_LIN, 2, PduR_DEST_FIM, 2},

        {PduR_PROTOCOL_FLEXRAY, 0, PduR_DEST_COM, 0},
        {PduR_PROTOCOL_FLEXRAY, 1, PduR_DEST_DCM, 1},
        {PduR_PROTOCOL_FLEXRAY, 2, PduR_DEST_FIM, 2}, 
    */
};
